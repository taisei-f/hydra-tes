...
datafile = '../data/feature.hdf5'

energy = []
with h5py.File(datafile, 'r') as h5:
    energy.append(h5['Calibration']['Pix0']["Energy"][()])
    energy.append(h5['Calibration']['Pix1']["Energy"][()])
    energy.append(h5['Calibration']['Pix2']["Energy"][()])
    energy.append(h5['Calibration']['Pix3']["Energy"][()])
...
for pixnum in range(4):
    ...
    print("Gaussian fit @5.9 keV for Pix"+str(pixnum))
